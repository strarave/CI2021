	...
	\part{Software Infrastructure}
		...
		\section{Cloud Computing and Edge/Fog Computing}
			...
			\subsection{Cloud Computing and Services}
				...
				\subsubsection{Communication as a Service}
			...
			\subsection{RAID}
				...
				\subsubsection{RAID 1}
					...
					\begin{itemize}
						...
						\item RAID 1 + 0: mirror then strip. The data is first mirrored in two clusters and then striped in the individual clusters. The difference between 0+1 and 1+0 can be appreciated only on clusters of more then 4 disks. This configuration is more fault tolerant than the 0+1
					\end{itemize}
				...
				\subsubsection{RAID 5 and 6}
					...
					RAID 6 further improves RAID 5 idea, doubling the parity blocks across disks. This "throws away" two disks in the array, but the entire configuration can now tolerate the failure of two disks.
